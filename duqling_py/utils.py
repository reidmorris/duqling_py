...
def quack(
    ...
    if input_dim is not None:
        ...
        filtered_registry = {
            k: v for k, v in filtered_registry.items() if v["input_dim"] in input_dim
        }

    if input_cat is not None:
        filtered_registry = {
            k: v for k, v in filtered_registry.items() if v["input_cat"] == input_cat
        }
    ...
    if stochastic is not None:
        filtered_registry = {
            k: v for k, v in filtered_registry.items() if v["stochastic"] == stochastic
        }
