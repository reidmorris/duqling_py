...
def run_one_sim_case(rr, seed=42, fn=None, fnum=None, p=1, n=10, nsr=0, 
                    dsgn="random", n_test=10, conf_level=None, score=True, 
                    method_names=None, fit_func=None, pred_func=None, verbose=False):
    """
...
def run_sim_study(fit_func, pred_func=None, fnames=None, conf_level=None, 
                 score=True, n_train=100, n_test=1000, NSR=0, 
                 design_type="LHS", replications=1, seed=42, 
                 method_names=None, mc_cores=1, verbose=True):
    """
...
def run_one_sim_case_data(k, XX=None, yy=None, groups=None, cv_type=None, 
                         dn=None, score=None, conf_level=None, method_names=None, 
                         custom_data_name=None, fit_func=None, pred_func=None, verbose=None):
    """
...
def run_sim_study_data(fit_func, pred_func=None, dnames=None, dsets=None, 
                      folds=20, seed=42, conf_level=None, score=True, 
                      method_names=None, custom_data_names=None, 
                      mc_cores=1, verbose=True):
    """
    ...
    if custom_data_names is not None and len(custom_data_names) > 0 and dsets is not None:
